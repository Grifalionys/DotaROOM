package grifalion.ru.dotaroom.network
...
class NetworkConnection(private val context: Context): LiveData<Boolean>() {
    ...
    private fun updateNetworkConnection() {
        try{
            val newtworkConnection: NetworkInfo? = connectivityManager?.activeNetworkInfo

            postValue(newtworkConnection?.isConnected==true)
